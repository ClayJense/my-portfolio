          ...
          >
            {cert.url ? (
              <Link
                ...
                className="group flex h-full flex-col rounded-xl border border-border bg-card p-4 sm:p-6 text-card-foreground shadow-sm transition-shadow hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
              ...
              <article className="flex h-full flex-col rounded-xl border border-border bg-card p-4 sm:p-6 text-card-foreground shadow-sm">
                <div className="flex items-start gap-3">
                  <span className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary">
                    <Award className="size-5" />
                  </span>
